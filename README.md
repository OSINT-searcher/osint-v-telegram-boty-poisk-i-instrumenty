...
|----------|------------------------------------------------------------------|----------------------------------------|
|📲🪙🆓| [Sherlock](https://t.me/Fyijkopouh_huukbhh_bot?start=_ref_9pyalm_JJwlz5) | **Крупный и детальнейший инструмент** поиска данных по человеку.|
|📲♻️🆓| [Vektor](https://t.me/Bigibik_bot?start=r_eFGr1BT2b5) | Сервис для общего поиска, в том числе и Телеграм.|
|📲🪙  | [Enigma](https://t.me/ynigmasscflbot?start=C96FP5YS) | Бот для поиска данных и пробива, с редкими базами.|
|📲🪙  | [Himera](https://t.me/himer33fjierjfkoweijbot?start=406840159) | Законный бот, но из-за этого достаточно дорогой.|
|📲🪙🆓| [FunStat](https://t.me/telestat0_bot?start=01083996516B74617466) | Поиск сообщений человека в Телеграм, чатов и прочей активности в ТГ.|
...
|📲🪙  | [Бот Лихо](https://t.me/likho_bot)| Бот ищущий негативную информацию по Телеграм сообщениям и загружаемым файлам. Отличный вариант для поиска "грязных трусов" пользователей или при проверке сотрудников.|
...
|📲🪙  | [Telesint](https://t.me/telesintitbot?start=ref_0e028efa34) | Поиск чатов и групп человека и поиск пользователей по имени.|
...
* Криптовалюта через [Официальный кошелек](https://t.me/wallet/start?startapp=ref-1-g__tgEbYk3k) или [Телеграм кошелек Crypto Bot](https://t.me/send?start=r-ezc61). Если другие методы не работают, создайте криптокошелек в Telegram. Это официальные приложения, которые позволяют легко купить криптовалюту картой и пополнить нужный бот.
...
| Метки  | Ссылка | Описание  |
|----------|------------------------------------------------------------------|----------------------------------------|
|📲🪙🆓| [Телеграм бот FunStat](https://t.me/telestat0_bot?start=01083996516B74617466) | Поиск сообщений человека в Телеграм, чатов и прочей активности в ТГ.|
|📲🪙  | [Телеграм бот Telesint](https://t.me/telesintitbot?start=ref_0e028efa34) | Поиск чатов и групп человека и поиск пользователей по имени.|
...
Данный текст содержит описание возможностей OSINT Телеграм ботов, примеры пробива через Telegram боты и общие принципы работы с инструментами [Telegram OSINT](https://github.com/OSINT-searcher/OSINT_i_deanon_Telegram). Весь материал представлен исключительно в образовательных и демонстрационных целях, чтобы помочь понять риски и научиться защищать свои данные.
